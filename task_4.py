...
if revenue > costs:
    print(f"Profit- {fin_res}")
elif revenue < costs:
    print(f"Loss -{fin_res}")
else:
    print("The company worked without profit")
print(f"Return on revenue - {fin_res / revenue}")
print(f"Company profit staff - {fin_res / staff}")
